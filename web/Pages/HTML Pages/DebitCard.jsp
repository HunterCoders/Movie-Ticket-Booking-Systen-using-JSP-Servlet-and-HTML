            ...
            <div class='window'>
                <div class='order-info'>
                    <div class='order-info-content'>
                        ...
                        <div class='line'></div>
                        <form action="submitUserDetails.jsp?paymd=Debit_Card" method="post">
                ...
                <div class='credit-info'>
                    <div class='credit-info-content'>
                        <img src='../../Images/DebitCard.png' height='80' class='credit-card-image' id='credit-card-image'></img>
                        Card Number
                        ...
                        <button class='pay-btn' id="checkout">Checkout</button>
            ...
            <script>
                ...
                function checkCVV(idval)
                {
                    if (idval.value.length !== 3)
                    {
                        ...
                        document.getElementById("cvverr").innerHTML = "Enter a valid CVV";
                        return false;
                    } else
                    {
